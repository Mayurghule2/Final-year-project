...
const JobListingsPage = () => {
  ...
  const isEligibleForJob = (job: any) => {
    ...
    const studentTenth = parseFloat(studentProfile.tenthPercentage) || 0;
    const jobMinTenth = parseFloat(job.minTenthPercentage) || 0;
    
    const studentTwelfth = parseFloat(studentProfile.twelfthPercentage) || 0;
    const jobMinTwelfth = parseFloat(job.minTwelfthPercentage) || 0;
    
    const studentBacklogs = parseInt(studentProfile.backlogs) || 0;
    const jobMaxBacklogs = parseInt(job.maxBacklogs) || 0;

    return (
      studentCGPA >= jobMinCGPA &&
      studentTenth >= jobMinTenth &&
      studentTwelfth >= jobMinTwelfth &&
      studentBacklogs <= jobMaxBacklogs
    );
  };
                ...
                availableJobs.map((job) => {
                  ...
                  return (
                    ...
                    >
                      <div className="p-4 sm:p-6">
                        {!isEligible && (
                          <div className="mb-3 bg-red-50 p-2 rounded-lg flex items-center gap-2 text-red-700 text-sm">
                            <XCircle className="h-4 w-4" />
                            <span>You are not eligible for this position</span>
                          </div>
                        )}
                        ...
                        <div className="mt-3 sm:mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-4 text-xs sm:text-sm">
                          ...
                          <div className="flex items-center text-gray-700">
                            <span className="mr-1 sm:mr-2 text-green-500">₹</span>
                            <span>{job.salaryRange.replace('$', '₹')}</span>
                          </div>
                          <div className="flex items-center text-gray-700">
                            <Clock className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2 text-yellow-500" />
                            <span>
                  ...
                  >
                    <div className="p-4 sm:p-6">
                      ...
                      <div className="mt-3 sm:mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-4 text-xs sm:text-sm">
                        ...
                        <div className="flex items-center text-gray-700">
                          <span className="mr-1 sm:mr-2 text-green-500">₹</span>
                          <span>{application.salaryRange.replace('$', '₹')}</span>
                        </div>
                        <div className="flex items-center text-gray-700">
                          <Clock className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2 text-yellow-500" />
                          <span>
